...
public static class BrickBreaker
{
    ...
    public static Tilemap GenerateRowOfBlocks(int rowLength, GameObject[] blocks, float skipPercentage, Vector3 origin, Tilemap parent)
    {
        ...
        for (int i = 0; i < blocksIndexList.Count; i++)
        {
            ...
            else
            {
                ...
                GameObject.Instantiate(original: blocks[index], position: position, rotation: Quaternion.identity, parent: parent.transform);
            }
        }
